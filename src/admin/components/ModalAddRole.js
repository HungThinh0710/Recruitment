...
export default class ModalAddRole extends Component {
  ...
  async componentDidMount() {
    ...
    var url = 'https://enclave-recruitment-management.herokuapp.com/api/permission?page=1';
  ...
  handlePageChange(pageNumber) {
    ...
    var { listChecked } = this.state;
    var url = 'https://enclave-recruitment-management.herokuapp.com/api/permission?page=' + pageNumber;
    fetch(url, {
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
    ...
    fetch(url, {
      ...
      .then(res => {
        ...
        if (res.status === 200) {
          ...
          var url2 =
            'https://enclave-recruitment-management.herokuapp.com/api/list-role?page=' + this.props.page;
          res.json().then(data => {
            fetch(url2, {
              method: 'POST',
              headers: {
