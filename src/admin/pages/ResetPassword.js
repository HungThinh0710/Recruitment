...
export default class ResetPassword extends React.Component {
  ...
  verifyToken(token) {
    var url = 'https://enclave-recruitment-management.herokuapp.com/api/password/verify/' + token;
    fetch(url, {
      headers: {
  ...
  handleSubmit() {
    ...
    if (password === '' || password_confirmation === '') {
      ...
      var url = 'https://enclave-recruitment-management.herokuapp.com/api/password/reset';
      fetch(url, {
        method: 'POST',
        body: JSON.stringify({
          password: password,
