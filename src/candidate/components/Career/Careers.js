...
export default class Careers extends Component {
  ...
  render() {
    axios({
      method: 'GET',
      url: 'http://api.enclavei3dev.tk/api/job',
      data: null
    }).then(res => {
      console.log(res);
    ...
    <div className="site-wrap">
        ...
        {/* HOME */}
        <section className="home-section section-hero inner-page overlay bg-image" style={{ backgroundImage: 'url("/candidate/images/back2.png")' }} id="career">
