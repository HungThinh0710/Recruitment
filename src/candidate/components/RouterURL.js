          ...
          <nav className="nav-brand">
            <div className="row align-items-center">
              ...
              <div className="right-cta-menu text-right d-flex aligin-items-center col-6">
                ...
                <NavLink to={"#"} className="site-menu-toggle js-menu-toggle d-inline-block d-xl-none mt-lg-2 ml-3" style={{marginTop: -40}}><a><span className="icon-menu h3 m-0 p-0 mt-1" /></a></NavLink>
              </div>
            </div>
            </nav>
