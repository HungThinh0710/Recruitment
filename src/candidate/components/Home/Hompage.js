...
export default class Homepage extends Component {
  ...
  async componentDidMount(perPage) {
    ...
    var  url = 'https://enclave-recruitment-management.herokuapp.com/api/article-web?page=' +activePage +
        '&perpage=' +
        perPage;
  ...
  handleFilter(keyword, pageNumber) {
    ...
    var url = 'https://enclave-recruitment-management.herokuapp.com/api/article-web?page=' + pageNumber + '&perpage=' + perPage;
    fetch(url, {
      method: 'POST',
      headers: headers,
      body: JSON.stringify(body)
  ...
  handlePageChange(pageNumber, keyword, location, status) {
    ...
    var url = 'https://enclave-recruitment-management.herokuapp.com/api/article-web?page=' + pageNumber + '&perpage=' +
    perPage;
    fetch(url, {
      method: 'POST',
      headers: headers,
